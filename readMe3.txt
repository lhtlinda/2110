...
path are also printed, the printing order is the direct path leading from start to finish person for BFS. and for DFS and BidirectionalBFS it is the search order. Bidirectional has the steadiest performance on average and BFS has some extreme cases where it takes very long because it's good mostly for closer elements while DFS is better for further ones. Bidirectional is noticeably better for larger data.
